...
namespace Fsp.Grpc.Api.Services
{
    public class ParksService : Visitor.VisitorBase
    {
        ...
        public override Task<ParksResponse> GetParks(ParksRequest request, ServerCallContext context)
        {
            ...
            result.Parks.Add(new Park { Id = 3, Name = "Alfred B. Maclay Gardens State Park", County = "Leon", Size = "1,180 acres (478ha)", Year = "1954", Water = "Lake Hall", Remarks = "Originally named Killearn Gardens State Park" });
